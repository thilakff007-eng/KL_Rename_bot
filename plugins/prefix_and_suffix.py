...
async def add_prefix(client, message):
    ...
    await TdDev.edit("__**✅ ᴘʀᴇꜰɪx ꜱᴀᴠᴇᴅ**__")
...
async def delete_prefix(client, message):
    ...
    if not prefix:
        return await TdDev.edit("__**😔 ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀɴʏ ᴘʀᴇꜰɪx**__")
    await digital_botz.set_prefix(message.from_user.id, None)
    await TdDev.edit("__**❌️ ᴘʀᴇꜰɪx ᴅᴇʟᴇᴛᴇᴅ**__")
...
async def see_prefix(client, message):
    ...
    prefix = await digital_botz.get_prefix(message.from_user.id)
    if prefix:
        await TdDev.edit(f"**ʏᴏᴜʀ ᴘʀᴇꜰɪx:-**\n\n`{prefix}`")
    else:
        await TdDev.edit("__**😔 ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀɴʏ ᴘʀᴇꜰɪx**__")
...
async def add_suffix(client, message):
    ...
    await TdDev.edit("__**✅ ꜱᴜꜰꜰɪx ꜱᴀᴠᴇᴅ**__")
...
async def delete_suffix(client, message):
    ...
    if not suffix:
        return await TdDev.edit("__**😔 ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀɴʏ ꜱᴜꜰꜰɪx**__")
    await digital_botz.set_suffix(message.from_user.id, None)
    await TdDev.edit("__**❌️ ꜱᴜꜰꜰɪx ᴅᴇʟᴇᴛᴇᴅ**__")
...
async def see_suffix(client, message):
    ...
    suffix = await digital_botz.get_suffix(message.from_user.id)
    if suffix:
        await TdDev.edit(f"**ʏᴏᴜʀ ꜱᴜꜰꜰɪx:-**\n\n`{suffix}`")
    else:
        await TdDev.edit("__**😔 ʏᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀɴʏ ꜱᴜꜰꜰɪx**__")
